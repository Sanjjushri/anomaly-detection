...
Generates high-dimensional financial trade data with embedded anomalies.
"""
    ...
    def _generate_anomalous_trade(self, normal_trade: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if anomaly_type == 'price_spike':
            ...
            anomaly_reasons.extend([
                ...
                f'VWAP deviation: {(anomalous_trade["vwap_deviation"]*100):.1f}%'
            ])
            ...
            anomaly_reasons.extend([
                ...
                f'High sector beta: {anomalous_trade["sector_beta"]:.2f}'
            ])
        
        anomalous_trade['is_anomaly'] = True
        anomalous_trade['anomaly_reasons'] = anomaly_reasons
        anomalous_trade['anomaly_type'] = anomaly_type
        
        return anomalous_trade

def main():
    """Generate and save the trade dataset."""
    ...
    for size, data in datasets.items():
        filename = f'trade_dataset_{size}.json'
